        ...
        <template>
          <v-card flat max-width elevation="24" color="grey darken-4">
            <v-card-title
              ...
              style="width: 100%"
            >
              <div>{{ system_name }} - ({{ constellation_name }})</div>
              ...
              <div>
                <v-progress-circular
                  ...
                  :strokeWidth="4"
                  :value="
                    (nodeCountHackingCountMultiCampagin / nodeCount) * 100 ||
                    0.000001
                  "
                >
                  <div class="caption">
      ...
      <v-card-actions class="pt-4 d-inline-flex">
        <div class="d-flex-block" style="width: 100%">
          ...
          >
            ...
            <SystemTidiMulti :CampaignSolaSystem="CampaignSolaSystem">
            </SystemTidiMulti>
          </div>
          <div
            class="d-inline-flex justify-md-space-between"
...
export default {
  ...
  data() {
    return {
      headers: [
        { text: "Target", value: "text", width: "18%", align: "start" },
  ...
  methods: {
    ...
    updatetext(item) {
      ...
      if (item.notes == null) {
        ...
        var note =
          this.$store.state.user_name + ": " + this.noteText + item.notes;
      }
      item.notes = note;
      let request = {
        notes: note,
